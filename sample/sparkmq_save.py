...
if __name__ == "__main__":
	...
	#conf = SparkConf().setAppName("PythonStreamingSparkMQWordCount").setMaster('spark://' + '10.75.57.21:7077')
    ...
    mqDstreams = [MQUtils.createStream(ssc, server, int(port), queuename, int(threadnum), StorageLevel.MEMORY_ONLY) for _ in range (int(numstream))]
    mqRDD = ssc.union(*mqDstreams)
    mqRDD.saveAsTextFiles("hdfs://10.75.57.21:9000/tmp/zhangjun9/spark/savefile")
...
##    counts.pprint()
#    counts.saveAsTextFiles("hdfs://10.75.57.21:9000/tmp/zhangjun9/spark/result")
#    uv_cnts.saveAsTextFiles("hdfs://10.75.57.21:9000/tmp/zhangjun9/spark/uv")
